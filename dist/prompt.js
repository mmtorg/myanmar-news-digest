...
- 【ミン・アウン・フライン個人に付くレッテル】（クーデター指導者・テロリスト指導者・テロリストの・ファシスト指導者 等）
  → 「ミン・アウン・フライン総司令官」または「ミン・アウン・フライン」とする。
  使用可能な肩書きは「総司令官（Commander-in-Chief）」のみ。Chairman・Acting President等の国家元首性を示す表現は地の文では使用しない。
  （引用・スローガン・発言部分に含まれる場合は原文どおり保持する）
