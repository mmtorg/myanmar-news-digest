...
【用語統一】武装組織→武装勢力、軍事政権系→国軍系、関与→主導
【通貨】チャット建てのみで表記（円換算しない）
【修正パターン参考】発言は「」で囲む／地名は州・管区レベル／重要な背景（圧力等）を補足
`;
...
【要点】30文字以内・主語と動作を明確に・重複語と曖昧表現（〜と述べた等）は避ける
`;
...
【要点】30文字以内・主語と動作を明確に・固有名詞と数値は残す・曖昧な断定は避ける
`;
...
【要点】30文字以内・主語と動作を明確に・重複語と曖昧表現は避ける・背景と地名を補足
`;
}
